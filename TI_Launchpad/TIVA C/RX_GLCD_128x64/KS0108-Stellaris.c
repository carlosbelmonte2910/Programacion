...
void GLCD_WriteCommand(unsigned char commandToWrite, unsigned char controller)
{
  ...
  GPIOPinWrite(KS0108_CTRL_PORT, KS0108_RS, 0x00);	//RS and RW Low
...
unsigned char GLCD_ReadData(void)
{
  ...
  GPIOPinWrite(KS0108_CTRL_PORT, KS0108_RS, 0xFF);	//Set RS and RW high
...
void GLCD_InitalizePorts(void)
{
  ...
  GPIOPinTypeGPIOOutput(KS0108_CTRL_PORT, KS0108_RS | KS0108_EN | KS0108_CS1 | KS0108_CS2);

  //Set CS pins high
  GPIOPinWrite(KS0108_CTRL_PORT, KS0108_CS1 | KS0108_CS2, 0xFF);
}
//-------------------------------------------------------------------------------------------------
//
//-------------------------------------------------------------------------------------------------
