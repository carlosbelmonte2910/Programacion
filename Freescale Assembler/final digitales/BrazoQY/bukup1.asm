...
indef1         	equ	3		;salida,todavia nose
indef2		equ	4		;salida,todavia nose
entAdc3		equ	5		;entrada,proteccion por ADC
...
;******************************************************************************
	...
	mov	#$00,TCH0H
	mov	#110t,TCH0L              ;configuro p/ que comienze con un ancho de 0,5ms
